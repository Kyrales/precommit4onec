...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач Приложение) Экспорт
	...
	Иначе
		Лог.Отладка("КомандаВыполнитьСценарии.ВыполнитьКоманду(): Перед выполнением СценарииОбработки.ПолучитьСценарииСПараметрамиВыполнения(): ИменаЗагружаемыхСценариев = Пустые " + ИменаЗагружаемыхСценариев);
	КонецЕсли;
	...
	Лог.Отладка("КомандаВыполнитьСценарии.ВыполнитьКоманду(): РазрешенныеФайлыОбработкиРегулярныеВыражения = " + СтрСоединить(РазрешенныеФайлыОбработкиРегулярныеВыражения,";"));
	ИсключенныеФайлыОбработкиРегулярныеВыражения = МенеджерНастроек.ЗначениеНастройки("ИсключенныеФайлыОбработки", "", Новый Массив);
	Лог.Отладка("КомандаВыполнитьСценарии.ВыполнитьКоманду(): ИсключенныеФайлыОбработкиРегулярныеВыражения = " + СтрСоединить(ИсключенныеФайлыОбработкиРегулярныеВыражения,";"));
...
Функция ПараметрыВыполнения(ПараметрыКоманды, Приложение)
	...
	Если ЗначениеЗаполнено(ПараметрИменаЗагружаемыхСценариев) Тогда
		...
		Лог.Отладка("Класс КомандаВыполнитьСценарии.ПараметрыВыполнения(): Инициализированы имена выполняемых сценариев по команде rules: " + СтрСоединить(ИменаСценариев,";"))
	КонецЕсли;
