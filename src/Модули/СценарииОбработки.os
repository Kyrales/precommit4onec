			...
			Иначе
				...
				Для каждого ТекФайлЛокальногоСценария Из ФайлыЛокальныхСценариевДляОбработки Цикл
					...
					Если ИменаИсключаемыхСценариев.Найти(ТекФайлЛокальногоСценария.ИмяБезРасширения) = Неопределено
						...
						Лог.Отладка("СценарииОбработки.Загрузить(): Сценарий НЕ найден в списке исключений по настройке ОтключенныеСценарии: " + ТекФайлЛокальногоСценария.ИмяБезРасширения);	

					Иначе
						// Сценарий найден в списке исключений - пропускаем
						Лог.Отладка("СценарииОбработки.Загрузить(): Исключен из локальных сценариев по настройке ОтключенныеСценарии: " + ТекФайлЛокальногоСценария.ИмяБезРасширения);	
