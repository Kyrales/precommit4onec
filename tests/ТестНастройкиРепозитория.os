...
Процедура Тест_ОтключенныеНастройки() Экспорт
	...
	ОжидаемыеСценарии.Добавить("ПроверкаДублейУникальныхИдентификаторов.os");
	ОжидаемыеСценарии.Добавить("ПроверкаКорректностиXML.os");
	ОжидаемыеСценарии.Добавить("ПроверкаНаличияАртефактовGit.os");
...
Процедура Тест_НастройкиПроектов() Экспорт
	...
	ВсеСценарии = МенеджерНастроек.ПолучитьИменаСценариевКаталога(КаталогСценариев);
